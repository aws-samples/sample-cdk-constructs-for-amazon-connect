...
// node_modules/@aws-sdk/client-connectcases/dist-cjs/auth/httpAuthSchemeProvider.js
var require_httpAuthSchemeProvider = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/dist-cjs/auth/httpAuthSchemeProvider.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.resolveHttpAuthSchemeConfig = exports2.defaultConnectCasesHttpAuthSchemeProvider = exports2.defaultConnectCasesHttpAuthSchemeParametersProvider = void 0;
    var core_1 = (init_dist_es2(), __toCommonJS(dist_es_exports2));
    var util_middleware_1 = require_dist_cjs6();
    var defaultConnectCasesHttpAuthSchemeParametersProvider = async (config, context, input) => {
      return {
    ...
    exports2.defaultConnectCasesHttpAuthSchemeParametersProvider = defaultConnectCasesHttpAuthSchemeParametersProvider;
    ...
    var defaultConnectCasesHttpAuthSchemeProvider = (authParameters) => {
      const options = [];
    ...
    exports2.defaultConnectCasesHttpAuthSchemeProvider = defaultConnectCasesHttpAuthSchemeProvider;
...
// node_modules/@aws-sdk/client-connectcases/package.json
var require_package = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/package.json"(exports2, module2) {
    module2.exports = {
      ...
      homepage: "https://github.com/aws/aws-sdk-js-v3/tree/main/clients/client-connectcases",
      repository: {
        type: "git",
        url: "https://github.com/aws/aws-sdk-js-v3.git",
        directory: "clients/client-connectcases"
      }
    };
  }
});
...
// node_modules/@aws-sdk/client-connectcases/dist-cjs/endpoint/ruleset.js
var require_ruleset2 = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/dist-cjs/endpoint/ruleset.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.ruleSet = void 0;
    var s4 = "required";
    ...
    var j4 = { [v4]: "Endpoint" };
    var k4 = { [t4]: c4, [u4]: [{ [v4]: "UseFIPS" }, true] };
    var l4 = { [t4]: c4, [u4]: [{ [v4]: "UseDualStack" }, true] };
    var m4 = {};
    var n4 = { [t4]: "getAttr", [u4]: [{ [v4]: g4 }, "supportsFIPS"] };
    var o4 = { [t4]: c4, [u4]: [true, { [t4]: "getAttr", [u4]: [{ [v4]: g4 }, "supportsDualStack"] }] };
    var p4 = [k4];
    var q4 = [l4];
    var r4 = [{ [v4]: "Region" }];
    var _data4 = { version: "1.0", parameters: { Region: h4, UseDualStack: i4, UseFIPS: i4, Endpoint: h4 }, rules: [{ conditions: [{ [t4]: b4, [u4]: [j4] }], rules: [{ conditions: p4, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d4 }, { rules: [{ conditions: q4, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d4 }, { endpoint: { url: j4, properties: m4, headers: m4 }, type: e4 }], type: f4 }], type: f4 }, { rules: [{ conditions: [{ [t4]: b4, [u4]: r4 }], rules: [{ conditions: [{ [t4]: "aws.partition", [u4]: r4, assign: g4 }], rules: [{ conditions: [k4, l4], rules: [{ conditions: [{ [t4]: c4, [u4]: [a4, n4] }, o4], rules: [{ rules: [{ endpoint: { url: "https://cases-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m4, headers: m4 }, type: e4 }], type: f4 }], type: f4 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d4 }], type: f4 }, { conditions: p4, rules: [{ conditions: [{ [t4]: c4, [u4]: [n4, a4] }], rules: [{ rules: [{ endpoint: { url: "https://cases-fips.{Region}.{PartitionResult#dnsSuffix}", properties: m4, headers: m4 }, type: e4 }], type: f4 }], type: f4 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d4 }], type: f4 }, { conditions: q4, rules: [{ conditions: [o4], rules: [{ rules: [{ endpoint: { url: "https://cases.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m4, headers: m4 }, type: e4 }], type: f4 }], type: f4 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d4 }], type: f4 }, { rules: [{ endpoint: { url: "https://cases.{Region}.{PartitionResult#dnsSuffix}", properties: m4, headers: m4 }, type: e4 }], type: f4 }], type: f4 }], type: f4 }, { error: "Invalid Configuration: Missing Region", type: d4 }], type: f4 }] };
    exports2.ruleSet = _data4;
  }
});

// node_modules/@aws-sdk/client-connectcases/dist-cjs/endpoint/endpointResolver.js
var require_endpointResolver2 = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/dist-cjs/endpoint/endpointResolver.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.defaultEndpointResolver = void 0;
    var util_endpoints_1 = require_dist_cjs22();
...
// node_modules/@aws-sdk/client-connectcases/dist-cjs/runtimeConfig.shared.js
var require_runtimeConfig_shared2 = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/dist-cjs/runtimeConfig.shared.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var core_1 = (init_dist_es2(), __toCommonJS(dist_es_exports2));
...
// node_modules/@aws-sdk/client-connectcases/dist-cjs/runtimeConfig.js
var require_runtimeConfig2 = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/dist-cjs/runtimeConfig.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
...
// node_modules/@aws-sdk/client-connectcases/dist-cjs/index.js
var require_dist_cjs54 = __commonJS({
  "node_modules/@aws-sdk/client-connectcases/dist-cjs/index.js"(exports2) {
    "use strict";
    var middlewareHostHeader = require_dist_cjs3();
    var middlewareLogger = require_dist_cjs4();
    var middlewareRecursionDetection = require_dist_cjs5();
    ...
    var ConnectCasesClient2 = class extends smithyClient.Client {
      config;
      constructor(...[configuration]) {
        const _config_0 = runtimeConfig.getRuntimeConfig(configuration || {});
        super(_config_0);
        ...
        this.middlewareStack.use(middlewareRecursionDetection.getRecursionDetectionPlugin(this.config));
        this.middlewareStack.use(core.getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
          httpAuthSchemeParametersProvider: httpAuthSchemeProvider.defaultConnectCasesHttpAuthSchemeParametersProvider,
          identityProviderConfigProvider: async (config) => new core.DefaultIdentityProviderConfig({
            "aws.auth#sigv4": config.credentials
          })
        }));
    ...
    var ConnectCasesServiceException = class _ConnectCasesServiceException extends smithyClient.ServiceException {
      constructor(options) {
        super(options);
        Object.setPrototypeOf(this, _ConnectCasesServiceException.prototype);
      }
    };
    var AccessDeniedException3 = class _AccessDeniedException extends ConnectCasesServiceException {
      name = "AccessDeniedException";
      $fault = "client";
      constructor(opts) {
        super({
    ...
    var InternalServerException3 = class _InternalServerException extends ConnectCasesServiceException {
      name = "InternalServerException";
      $fault = "server";
      $retryable = {};
      retryAfterSeconds;
    ...
    var ValidationException2 = class _ValidationException extends ConnectCasesServiceException {
      name = "ValidationException";
      $fault = "client";
      constructor(opts) {
        super({
    ...
    var _AE = "AuditEvent";
    var _AEF = "AuditEventField";
    var _AEFL = "AuditEventFieldList";
    var _AEFVU = "AuditEventFieldValueUnion";
    var _AEL = "AuditEventsList";
    var _AEPB = "AuditEventPerformedBy";
    var _BC = "BooleanCondition";
    var _BCL = "BooleanConditionList";
    var _BGCR = "BatchGetCaseRule";
    var _BGCREL = "BatchGetCaseRuleErrorList";
    var _BGCRL = "BatchGetCaseRuleList";
    var _BGCRR = "BatchGetCaseRuleRequest";
    var _BGCRRa = "BatchGetCaseRuleResponse";
    var _BGF = "BatchGetField";
    var _BGFEL = "BatchGetFieldErrorList";
    var _BGFIL = "BatchGetFieldIdentifierList";
    var _BGFL = "BatchGetFieldList";
    var _BGFR = "BatchGetFieldRequest";
    var _BGFRa = "BatchGetFieldResponse";
    var _BL = "BasicLayout";
    var _BO = "BooleanOperands";
    var _BPFO = "BatchPutFieldOptions";
    var _BPFOR = "BatchPutFieldOptionsRequest";
    var _BPFORa = "BatchPutFieldOptionsResponse";
    var _C2 = "Contact";
    var _CC = "CommentContent";
    var _CCC = "ConnectCaseContent";
    var _CCF = "ConnectCaseFilter";
    var _CCIC = "ConnectCaseInputContent";
    var _CCR = "CreateCaseRequest";
    var _CCRR = "CreateCaseRuleRequest";
    var _CCRRr = "CreateCaseRuleResponse";
    var _CCRr = "CreateCaseResponse";
    var _CCRre = "CreateCaseRule";
    var _CCo = "ContactContent";
    var _CCr = "CreateCase";
    var _CCu = "CustomContent";
    var _CD = "CreateDomain";
    var _CDR = "CreateDomainRequest";
    var _CDRr = "CreateDomainResponse";
    var _CE = "CustomEntity";
    var _CEID = "CaseEventIncludedData";
    var _CEo = "ConflictException";
    var _CF = "CommentFilter";
    var _CFF = "CustomFieldsFilter";
    var _CFFL = "CustomFieldsFilterList";
    var _CFL = "CaseFilterList";
    var _CFR = "CreateFieldRequest";
    var _CFRr = "CreateFieldResponse";
    var _CFa = "CaseFilter";
    var _CFo = "ContactFilter";
    var _CFr = "CreateField";
    var _CFu = "CustomFilter";
    var _CIC = "CustomInputContent";
    var _CL = "CreateLayout";
    var _CLR = "CreateLayoutRequest";
    var _CLRr = "CreateLayoutResponse";
    var _CRD = "CaseRuleDetails";
    var _CRE = "CaseRuleError";
    var _CRI = "CaseRuleIdentifier";
    var _CRIL = "CaseRuleIdentifierList";
    var _CRIR = "CreateRelatedItemRequest";
    var _CRIRr = "CreateRelatedItemResponse";
    var _CRIr = "CreateRelatedItem";
    var _CRS = "CaseRuleSummary";
    var _CRSL = "CaseRuleSummaryList";
    var _CS2 = "CaseSummary";
    var _CSL = "CaseSummaryList";
    var _CT2 = "CreateTemplate";
    var _CTR2 = "CreateTemplateRequest";
    var _CTRr2 = "CreateTemplateResponse";
    var _DC = "DeleteCase";
    var _DCR = "DeleteCaseRequest";
    var _DCRR = "DeleteCaseRuleRequest";
    var _DCRRe = "DeleteCaseRuleResponse";
    var _DCRe = "DeleteCaseResponse";
    var _DCRel = "DeleteCaseRule";
    var _DD = "DeleteDomain";
    var _DDR = "DeleteDomainRequest";
    var _DDRe = "DeleteDomainResponse";
    var _DF = "DeleteField";
    var _DFR = "DeleteFieldRequest";
    var _DFRe = "DeleteFieldResponse";
    var _DL = "DeleteLayout";
    var _DLR = "DeleteLayoutRequest";
    var _DLRe = "DeleteLayoutResponse";
    var _DRI = "DeleteRelatedItem";
    var _DRIR = "DeleteRelatedItemRequest";
    var _DRIRe = "DeleteRelatedItemResponse";
    var _DS2 = "DomainSummary";
    var _DSL = "DomainSummaryList";
    var _DT = "DeleteTemplate";
    var _DTR = "DeleteTemplateRequest";
    var _DTRe = "DeleteTemplateResponse";
    var _EBC = "EventBridgeConfiguration";
    var _EFV = "EmptyFieldValue";
    var _EID = "EventIncludedData";
    var _EOV = "EmptyOperandValue";
    var _FC = "FileContent";
    var _FE = "FieldError";
    var _FF = "FileFilter";
    var _FFi = "FieldFilter";
    var _FG = "FieldGroup";
    var _FI = "FieldIdentifier";
    var _FIL = "FieldIdentifierList";
    var _FIi = "FieldItem";
    var _FL = "FieldList";
    var _FO = "FieldOption";
    var _FOCR = "FieldOptionsCaseRule";
    var _FOE = "FieldOptionError";
    var _FOEL = "FieldOptionErrorList";
    var _FOL = "FieldOptionsList";
    var _FS = "FieldSummary";
    var _FSL = "FieldSummaryList";
    var _FV = "FieldValue";
    var _FVL = "FieldValueList";
    var _FVU = "FieldValueUnion";
    var _GC = "GetCase";
    var _GCAE = "GetCaseAuditEvents";
    var _GCAER = "GetCaseAuditEventsRequest";
    var _GCAERe = "GetCaseAuditEventsResponse";
    var _GCEC = "GetCaseEventConfiguration";
    var _GCECR = "GetCaseEventConfigurationRequest";
    var _GCECRe = "GetCaseEventConfigurationResponse";
    var _GCR = "GetCaseRequest";
    var _GCRR = "GetCaseRuleResponse";
    var _GCRe = "GetCaseResponse";
    var _GD = "GetDomain";
    var _GDR = "GetDomainRequest";
    var _GDRe = "GetDomainResponse";
    var _GFR = "GetFieldResponse";
    var _GL = "GetLayout";
    var _GLR = "GetLayoutRequest";
    var _GLRe = "GetLayoutResponse";
    var _GT = "GetTemplate";
    var _GTR = "GetTemplateRequest";
    var _GTRe = "GetTemplateResponse";
    var _HCR = "HiddenCaseRule";
    var _ISE3 = "InternalServerException";
    var _LC = "LayoutConfiguration";
    var _LCFC = "ListCasesForContact";
    var _LCFCR = "ListCasesForContactRequest";
    var _LCFCRi = "ListCasesForContactResponse";
    var _LCR = "ListCaseRules";
    var _LCRR = "ListCaseRulesRequest";
    var _LCRRi = "ListCaseRulesResponse";
    var _LCa = "LayoutContent";
    var _LD = "ListDomains";
    var _LDR = "ListDomainsRequest";
    var _LDRi = "ListDomainsResponse";
    var _LF = "ListFields";
    var _LFO = "ListFieldOptions";
    var _LFOR = "ListFieldOptionsRequest";
    var _LFORi = "ListFieldOptionsResponse";
    var _LFR = "ListFieldsRequest";
    var _LFRi = "ListFieldsResponse";
    var _LL = "ListLayouts";
    var _LLR = "ListLayoutsRequest";
    var _LLRi = "ListLayoutsResponse";
    var _LS = "LayoutSections";
    var _LSL = "LayoutSummaryList";
    var _LSa = "LayoutSummary";
    ...
    var _OO = "OperandOne";
    var _OT = "OperandTwo";
    var _PCEC = "PutCaseEventConfiguration";
    var _PCECR = "PutCaseEventConfigurationRequest";
    var _PCECRu = "PutCaseEventConfigurationResponse";
    var _PCFOM = "ParentChildFieldOptionsMapping";
    var _PCFOML = "ParentChildFieldOptionsMappingList";
    var _RA2 = "Retry-After";
    var _RCR = "RequiredCaseRule";
    var _RF = "RequiredField";
    var _RFL = "RequiredFieldList";
    var _RIC = "RelatedItemContent";
    var _RIEID = "RelatedItemEventIncludedData";
    var _RIFL = "RelatedItemFilterList";
    var _RIIC = "RelatedItemInputContent";
    var _RITF = "RelatedItemTypeFilter";
    var _RNFE = "ResourceNotFoundException";
    var _S = "Sort";
    var _SARI = "SearchAllRelatedItems";
    var _SARIR = "SearchAllRelatedItemsRequest";
    var _SARIRI = "SearchAllRelatedItemsResponseItem";
    var _SARIRIL = "SearchAllRelatedItemsResponseItemList";
    var _SARIRe = "SearchAllRelatedItemsResponse";
    var _SARIS = "SearchAllRelatedItemsSort";
    var _SARISL = "SearchAllRelatedItemsSortList";
    var _SC = "SlaConfiguration";
    var _SCR = "SearchCasesRequest";
    var _SCRI = "SearchCasesResponseItem";
    var _SCRIL = "SearchCasesResponseItemList";
    var _SCRe = "SearchCasesResponse";
    var _SCe = "SearchCases";
    var _SCl = "SlaContent";
    var _SF = "SlaFilter";
    var _SFVUL = "SlaFieldValueUnionList";
    var _SIC = "SlaInputConfiguration";
    var _SICl = "SlaInputContent";
    var _SL = "SectionsList";
    var _SLo = "SortList";
    var _SN2 = "SlaName";
    var _SQEE = "ServiceQuotaExceededException";
    var _SRI = "SearchRelatedItems";
    var _SRIR = "SearchRelatedItemsRequest";
    var _SRIRI = "SearchRelatedItemsResponseItem";
    var _SRIRIL = "SearchRelatedItemsResponseItemList";
    var _SRIRe = "SearchRelatedItemsResponse";
    var _Se = "Section";
    var _T2 = "Tags";
    var _TCRL = "TemplateCaseRuleList";
    var _TE = "ThrottlingException";
    var _TR = "TemplateRule";
    var _TRR = "TagResourceRequest";
    var _TRa = "TagResource";
    var _TS = "TemplateSummary";
    var _TSL = "TemplateSummaryList";
    var _UC = "UpdateCase";
    var _UCR = "UpdateCaseRequest";
    var _UCRR = "UpdateCaseRuleRequest";
    var _UCRRp = "UpdateCaseRuleResponse";
    var _UCRp = "UpdateCaseResponse";
    var _UCRpd = "UpdateCaseRule";
    var _UF = "UpdateField";
    var _UFR = "UpdateFieldRequest";
    var _UFRp = "UpdateFieldResponse";
    var _UL = "UpdateLayout";
    var _ULR = "UpdateLayoutRequest";
    var _ULRp = "UpdateLayoutResponse";
    ...
    var _cD = "caseData";
    var _cE = "customEntity";
    var _cFI = "childFieldId";
    var _cFOV = "childFieldOptionValues";
    var _cI3 = "caseId";
    var _cR = "caseRules";
    var _cRA = "caseRuleArn";
    var _cRI = "caseRuleId";
    var _cT = "contentType";
    var _cTST = "connectedToSystemTime";
    ...
    var _dA = "domainArn";
    var _dI = "domainId";
    var _dL = "defaultLayout";
    var _dS = "domainStatus";
    var _dV = "defaultValue";
    var _dVo = "doubleValue";
    var _de = "deleted";
    var _do = "domains";
    var _e4 = "error";
    var _eB = "eventBridge";
    var _eC = "errorCode";
    var _eFI = "eventFieldId";
    var _eI3 = "eventId";
    var _eT = "equalTo";
    var _eV = "emptyValue";
    var _en = "enabled";
    ...
    var _fG = "fieldGroup";
    var _fI = "fieldId";
    var _fO = "fieldOptions";
    var _fi = "filters";
    var _fie = "field";
    var _fil = "filter";
    var _file = "file";
    var _gT3 = "greaterThan";
    var _gTOET = "greaterThanOrEqualTo";
    var _h3 = "hidden";
    var _hE4 = "httpError";
    var _hH = "httpHeader";
    var _hQ = "httpQuery";
    var _ht = "http";
    var _i = "id";
    var _iC = "includeContent";
    var _iD = "includedData";
    var _iPA = "iamPrincipalArn";
    var _l = "layouts";
    var _lA = "layoutArn";
    var _lC = "layoutConfiguration";
    var _lI = "layoutId";
    ...
    var _oV = "oldValue";
    var _pB = "performedBy";
    var _pCFOM = "parentChildFieldOptionsMappings";
    var _pFI = "parentFieldId";
    var _pFOV = "parentFieldOptionValue";
    var _pT = "performedTime";
    var _r2 = "result";
    var _rAS = "retryAfterSeconds";
    var _rF = "requiredFields";
    var _rI = "resourceId";
    var _rIA = "relatedItemArn";
    var _rID = "relatedItemData";
    var _rII = "relatedItemId";
    var _rIT = "relatedItemType";
    var _rIe = "relatedItems";
    var _rT3 = "ruleType";
    ...
    var _sIC = "slaInputConfiguration";
    var _sO = "sortOrder";
    var _sP = "sortProperty";
    var _sT2 = "searchTerm";
    var _sV = "stringValue";
    var _se2 = "server";
    var _sec = "sections";
    var _sl = "sla";
    var _sm3 = "smithy.ts.sdk.synthetic.com.amazonaws.connectcases";
    var _so = "sorts";
    var _sp = "sparse";
    var _t = "type";
    var _tA = "templateArn";
    var _tFV = "targetFieldValues";
    var _tI2 = "templateId";
    var _tK = "tagKeys";
    var _tP = "topPanel";
    var _tSM = "targetSlaMinutes";
    var _tT3 = "targetTime";
    var _ta = "tags";
    var _te = "templates";
    var _u = "user";
    var _uA = "userArn";
    var _uAV = "userArnValue";
    var _uCR = "unprocessedCaseRules";
    var _v = "value";
    var _va = "values";
    var n04 = "com.amazonaws.connectcases";
    var CustomEntity = [0, n04, _CE, 8, 0];
    var SlaName = [0, n04, _SN2, 8, 0];
    ...
    var AuditEvent$ = [
      ...
      _AE,
      0,
      [_eI3, _t, _pT, _f, _rIT, _pB],
      [0, 0, 5, [() => AuditEventFieldList, 0], 0, [() => AuditEventPerformedBy$, 0]],
      4
    ];
    var AuditEventField$ = [
      3,
    ...
    schema.TypeRegistry.for(n04).registerError(ConflictException$, ConflictException);
    var ConnectCaseContent$ = [
      3,
      n04,
      _CCC,
      0,
    ...
    var CreateCaseRuleRequest$ = [
      ...
      0,
      [_dI, _n, _ru, _d],
      [[0, 1], 0, () => CaseRuleDetails$, 0],
      3
    ];
    var CreateCaseRuleResponse$ = [
      3,
      n04,
      _CCRRr,
      0,
    ...
    var CreateRelatedItemRequest$ = [
      ...
      _CRIR,
      0,
      [_dI, _cI3, _t, _co3, _pB],
      [[0, 1], [0, 1], 0, [() => RelatedItemInputContent$, 0], [() => UserUnion$, 0]],
      4
    ];
    var CreateRelatedItemResponse$ = [
      3,
      n04,
      _CRIRr,
      0,
    ...
    var FieldOptionsCaseRule$ = [
      ...
      0,
      [_pCFOM, _pFI, _cFI],
      [() => ParentChildFieldOptionsMappingList, 0, 0],
      1
    ];
    var FieldSummary$ = [
      3,
    ...
    var GetCaseEventConfigurationRequest$ = [
      3,
      n04,
      _GCECR,
      0,
    ...
    var GetLayoutResponse$ = [
      ...
      _GLRe,
      0,
      [_lI, _lA, _n, _co3, _ta, _de, _cTr, _lMT],
    ...
    var GetTemplateResponse$ = [
      ...
      _GTRe,
      0,
      [_tI2, _tA, _n, _s4, _d, _lC, _rF, _ta, _de, _cTr, _lMT, _rul],
      [0, 0, 0, 0, 0, () => LayoutConfiguration$, () => RequiredFieldList, [() => Tags, 0], 2, 5, 5, () => TemplateCaseRuleList],
      4
    ];
    var HiddenCaseRule$ = [
      3,
    ...
    schema.TypeRegistry.for(n04).registerError(InternalServerException$3, InternalServerException3);
    ...
    var ListTemplatesRequest$ = [
      ...
      0,
      [_dI, _mR, _nT, _s4],
      [[0, 1], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }], [64 | 0, { [_hQ]: _s4 }]],
      1
    ];
    ...
    var ParentChildFieldOptionsMapping$ = [
      3,
      n04,
      _PCFOM,
      0,
    ...
    var PutCaseEventConfigurationResponse$ = [
      3,
      n04,
      _PCECRu,
      0,
    ...
    var RelatedItemEventIncludedData$ = [
      3,
      n04,
      _RIEID,
      0,
    ...
    var SearchAllRelatedItemsResponse$ = [
      ...
      0,
      [_rIe, _nT],
      [[() => SearchAllRelatedItemsResponseItemList, 0], 0],
      1
    ];
    var SearchAllRelatedItemsResponseItem$ = [
      ...
      _SARIRI,
      0,
      [_rII, _cI3, _t, _aT3, _co3, _pB, _ta],
      [0, 0, 0, 5, [() => RelatedItemContent$, 0], [() => UserUnion$, 0], [() => Tags, 0]],
      5
    ];
    var SearchAllRelatedItemsSort$ = [
      3,
      n04,
      _SARIS,
      0,
    ...
    var SearchCasesResponse$ = [
      ...
      0,
      [_ca, _nT],
      [[() => SearchCasesResponseItemList, 0], 0],
      1
    ];
    ...
    var SearchRelatedItemsResponse$ = [
      ...
      0,
      [_rIe, _nT],
      [[() => SearchRelatedItemsResponseItemList, 0], 0],
      1
    ];
    ...
    schema.TypeRegistry.for(n04).registerError(ServiceQuotaExceededException$, ServiceQuotaExceededException);
    var SlaConfiguration$ = [
      3,
      n04,
      _SC,
      0,
      [_n, _t, _s4, _tT3, _fI, _tFV, _cTo],
      [[() => SlaName, 0], 0, 0, 5, 0, () => SlaFieldValueUnionList, 5],
      4
    ];
    var SlaContent$ = [
      3,
    ...
    var SlaInputConfiguration$ = [
      ...
      0,
      [_n, _t, _tSM, _fI, _tFV],
      [[() => SlaName, 0], 0, 1, 0, () => SlaFieldValueUnionList],
      3
    ];
    var Sort$ = [
      3,
    ...
    schema.TypeRegistry.for(n04).registerError(ThrottlingException$, ThrottlingException);
    ...
    var UpdateTemplateRequest$ = [
      ...
      _UTR,
      0,
      [_dI, _tI2, _n, _d, _lC, _rF, _s4, _rul],
    ...
    var __Unit = "unit";
    var ConnectCasesServiceException$ = [-3, _sm3, "ConnectCasesServiceException", 0, [], []];
    schema.TypeRegistry.for(_sm3).registerError(ConnectCasesServiceException$, ConnectCasesServiceException);
    ...
    var BatchGetFieldIdentifierList = [
      1,
      n04,
      _BGFIL,
      0,
    ...
    var SearchAllRelatedItemsSortList = [
      1,
      n04,
      _SARISL,
      0,
    ...
    var FieldFilter$ = [
      ...
      _FFi,
      0,
      [_eT, _cont, _gT3, _gTOET, _lT, _lTOET],
    ...
    var BatchGetCaseRuleCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "BatchGetCaseRule", {}).n("ConnectCasesClient", "BatchGetCaseRuleCommand").sc(BatchGetCaseRule$).build() {
    };
    var BatchGetFieldCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "BatchGetField", {}).n("ConnectCasesClient", "BatchGetFieldCommand").sc(BatchGetField$).build() {
    };
    var BatchPutFieldOptionsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "BatchPutFieldOptions", {}).n("ConnectCasesClient", "BatchPutFieldOptionsCommand").sc(BatchPutFieldOptions$).build() {
    };
    var CreateCaseCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateCase", {}).n("ConnectCasesClient", "CreateCaseCommand").sc(CreateCase$).build() {
    };
    var CreateCaseRuleCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateCaseRule", {}).n("ConnectCasesClient", "CreateCaseRuleCommand").sc(CreateCaseRule$).build() {
    };
    var CreateDomainCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateDomain", {}).n("ConnectCasesClient", "CreateDomainCommand").sc(CreateDomain$).build() {
    };
    var CreateFieldCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateField", {}).n("ConnectCasesClient", "CreateFieldCommand").sc(CreateField$).build() {
    };
    var CreateLayoutCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateLayout", {}).n("ConnectCasesClient", "CreateLayoutCommand").sc(CreateLayout$).build() {
    };
    var CreateRelatedItemCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateRelatedItem", {}).n("ConnectCasesClient", "CreateRelatedItemCommand").sc(CreateRelatedItem$).build() {
    };
    var CreateTemplateCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "CreateTemplate", {}).n("ConnectCasesClient", "CreateTemplateCommand").sc(CreateTemplate$).build() {
    };
    var DeleteCaseCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteCase", {}).n("ConnectCasesClient", "DeleteCaseCommand").sc(DeleteCase$).build() {
    };
    var DeleteCaseRuleCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteCaseRule", {}).n("ConnectCasesClient", "DeleteCaseRuleCommand").sc(DeleteCaseRule$).build() {
    };
    var DeleteDomainCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteDomain", {}).n("ConnectCasesClient", "DeleteDomainCommand").sc(DeleteDomain$).build() {
    };
    var DeleteFieldCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteField", {}).n("ConnectCasesClient", "DeleteFieldCommand").sc(DeleteField$).build() {
    };
    var DeleteLayoutCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteLayout", {}).n("ConnectCasesClient", "DeleteLayoutCommand").sc(DeleteLayout$).build() {
    };
    var DeleteRelatedItemCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteRelatedItem", {}).n("ConnectCasesClient", "DeleteRelatedItemCommand").sc(DeleteRelatedItem$).build() {
    };
    var DeleteTemplateCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "DeleteTemplate", {}).n("ConnectCasesClient", "DeleteTemplateCommand").sc(DeleteTemplate$).build() {
    };
    var GetCaseAuditEventsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "GetCaseAuditEvents", {}).n("ConnectCasesClient", "GetCaseAuditEventsCommand").sc(GetCaseAuditEvents$).build() {
    };
    var GetCaseCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "GetCase", {}).n("ConnectCasesClient", "GetCaseCommand").sc(GetCase$).build() {
    };
    var GetCaseEventConfigurationCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "GetCaseEventConfiguration", {}).n("ConnectCasesClient", "GetCaseEventConfigurationCommand").sc(GetCaseEventConfiguration$).build() {
    };
    var GetDomainCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "GetDomain", {}).n("ConnectCasesClient", "GetDomainCommand").sc(GetDomain$).build() {
    };
    var GetLayoutCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "GetLayout", {}).n("ConnectCasesClient", "GetLayoutCommand").sc(GetLayout$).build() {
    };
    var GetTemplateCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "GetTemplate", {}).n("ConnectCasesClient", "GetTemplateCommand").sc(GetTemplate$).build() {
    };
    var ListCaseRulesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListCaseRules", {}).n("ConnectCasesClient", "ListCaseRulesCommand").sc(ListCaseRules$).build() {
    };
    var ListCasesForContactCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListCasesForContact", {}).n("ConnectCasesClient", "ListCasesForContactCommand").sc(ListCasesForContact$).build() {
    };
    var ListDomainsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListDomains", {}).n("ConnectCasesClient", "ListDomainsCommand").sc(ListDomains$).build() {
    };
    var ListFieldOptionsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListFieldOptions", {}).n("ConnectCasesClient", "ListFieldOptionsCommand").sc(ListFieldOptions$).build() {
    };
    var ListFieldsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListFields", {}).n("ConnectCasesClient", "ListFieldsCommand").sc(ListFields$).build() {
    };
    var ListLayoutsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListLayouts", {}).n("ConnectCasesClient", "ListLayoutsCommand").sc(ListLayouts$).build() {
    };
    var ListTagsForResourceCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListTagsForResource", {}).n("ConnectCasesClient", "ListTagsForResourceCommand").sc(ListTagsForResource$).build() {
    };
    var ListTemplatesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "ListTemplates", {}).n("ConnectCasesClient", "ListTemplatesCommand").sc(ListTemplates$).build() {
    };
    var PutCaseEventConfigurationCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "PutCaseEventConfiguration", {}).n("ConnectCasesClient", "PutCaseEventConfigurationCommand").sc(PutCaseEventConfiguration$).build() {
    };
    var SearchAllRelatedItemsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "SearchAllRelatedItems", {}).n("ConnectCasesClient", "SearchAllRelatedItemsCommand").sc(SearchAllRelatedItems$).build() {
    };
    var SearchCasesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "SearchCases", {}).n("ConnectCasesClient", "SearchCasesCommand").sc(SearchCases$).build() {
    };
    var SearchRelatedItemsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "SearchRelatedItems", {}).n("ConnectCasesClient", "SearchRelatedItemsCommand").sc(SearchRelatedItems$).build() {
    };
    var TagResourceCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "TagResource", {}).n("ConnectCasesClient", "TagResourceCommand").sc(TagResource$).build() {
    };
    var UntagResourceCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "UntagResource", {}).n("ConnectCasesClient", "UntagResourceCommand").sc(UntagResource$).build() {
    };
    var UpdateCaseCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "UpdateCase", {}).n("ConnectCasesClient", "UpdateCaseCommand").sc(UpdateCase$).build() {
    };
    var UpdateCaseRuleCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "UpdateCaseRule", {}).n("ConnectCasesClient", "UpdateCaseRuleCommand").sc(UpdateCaseRule$).build() {
    };
    var UpdateFieldCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "UpdateField", {}).n("ConnectCasesClient", "UpdateFieldCommand").sc(UpdateField$).build() {
    };
    var UpdateLayoutCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "UpdateLayout", {}).n("ConnectCasesClient", "UpdateLayoutCommand").sc(UpdateLayout$).build() {
    };
    var UpdateTemplateCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AmazonConnectCases", "UpdateTemplate", {}).n("ConnectCasesClient", "UpdateTemplateCommand").sc(UpdateTemplate$).build() {
    };
    var commands4 = {
      ...
      CreateDomainCommand: CreateDomainCommand2,
      CreateFieldCommand,
      CreateLayoutCommand,
      ...
      DeleteDomainCommand: DeleteDomainCommand2,
      DeleteFieldCommand,
      DeleteLayoutCommand,
    ...
    var ConnectCases = class extends ConnectCasesClient2 {
    };
    smithyClient.createAggregatedClient(commands4, ConnectCases);
    var paginateGetCase = core.createPaginator(ConnectCasesClient2, GetCaseCommand, "nextToken", "nextToken", "");
    var paginateGetCaseAuditEvents = core.createPaginator(ConnectCasesClient2, GetCaseAuditEventsCommand, "nextToken", "nextToken", "maxResults");
    var paginateListCaseRules = core.createPaginator(ConnectCasesClient2, ListCaseRulesCommand, "nextToken", "nextToken", "maxResults");
    var paginateListCasesForContact = core.createPaginator(ConnectCasesClient2, ListCasesForContactCommand, "nextToken", "nextToken", "maxResults");
    var paginateListDomains = core.createPaginator(ConnectCasesClient2, ListDomainsCommand, "nextToken", "nextToken", "maxResults");
    var paginateListFieldOptions = core.createPaginator(ConnectCasesClient2, ListFieldOptionsCommand, "nextToken", "nextToken", "maxResults");
    var paginateListFields = core.createPaginator(ConnectCasesClient2, ListFieldsCommand, "nextToken", "nextToken", "maxResults");
    var paginateListLayouts = core.createPaginator(ConnectCasesClient2, ListLayoutsCommand, "nextToken", "nextToken", "maxResults");
    var paginateListTemplates = core.createPaginator(ConnectCasesClient2, ListTemplatesCommand, "nextToken", "nextToken", "maxResults");
    var paginateSearchAllRelatedItems = core.createPaginator(ConnectCasesClient2, SearchAllRelatedItemsCommand, "nextToken", "nextToken", "maxResults");
    var paginateSearchCases = core.createPaginator(ConnectCasesClient2, SearchCasesCommand, "nextToken", "nextToken", "maxResults");
    var paginateSearchRelatedItems = core.createPaginator(ConnectCasesClient2, SearchRelatedItemsCommand, "nextToken", "nextToken", "maxResults");
    var RelatedItemType = {
      COMMENT: "Comment",
    ...
    exports2.AuditEvent$ = AuditEvent$;
    exports2.AuditEventField$ = AuditEventField$;
    exports2.AuditEventFieldValueUnion$ = AuditEventFieldValueUnion$;
    exports2.AuditEventPerformedBy$ = AuditEventPerformedBy$;
    exports2.AuditEventType = AuditEventType;
    exports2.BasicLayout$ = BasicLayout$;
    exports2.BatchGetCaseRule$ = BatchGetCaseRule$;
    exports2.BatchGetCaseRuleCommand = BatchGetCaseRuleCommand;
    exports2.BatchGetCaseRuleRequest$ = BatchGetCaseRuleRequest$;
    exports2.BatchGetCaseRuleResponse$ = BatchGetCaseRuleResponse$;
    exports2.BatchGetField$ = BatchGetField$;
    exports2.BatchGetFieldCommand = BatchGetFieldCommand;
    exports2.BatchGetFieldRequest$ = BatchGetFieldRequest$;
    exports2.BatchGetFieldResponse$ = BatchGetFieldResponse$;
    exports2.BatchPutFieldOptions$ = BatchPutFieldOptions$;
    exports2.BatchPutFieldOptionsCommand = BatchPutFieldOptionsCommand;
    exports2.BatchPutFieldOptionsRequest$ = BatchPutFieldOptionsRequest$;
    exports2.BatchPutFieldOptionsResponse$ = BatchPutFieldOptionsResponse$;
    exports2.BooleanCondition$ = BooleanCondition$;
    exports2.BooleanOperands$ = BooleanOperands$;
    exports2.CaseEventIncludedData$ = CaseEventIncludedData$;
    exports2.CaseFilter$ = CaseFilter$;
    exports2.CaseRuleDetails$ = CaseRuleDetails$;
    exports2.CaseRuleError$ = CaseRuleError$;
    exports2.CaseRuleIdentifier$ = CaseRuleIdentifier$;
    exports2.CaseRuleSummary$ = CaseRuleSummary$;
    exports2.CaseSummary$ = CaseSummary$;
    exports2.CommentBodyTextType = CommentBodyTextType;
    exports2.CommentContent$ = CommentContent$;
    exports2.CommentFilter$ = CommentFilter$;
    exports2.ConflictException = ConflictException;
    exports2.ConflictException$ = ConflictException$;
    exports2.ConnectCaseContent$ = ConnectCaseContent$;
    exports2.ConnectCaseFilter$ = ConnectCaseFilter$;
    exports2.ConnectCaseInputContent$ = ConnectCaseInputContent$;
    exports2.ConnectCases = ConnectCases;
    exports2.ConnectCasesClient = ConnectCasesClient2;
    exports2.ConnectCasesServiceException = ConnectCasesServiceException;
    exports2.ConnectCasesServiceException$ = ConnectCasesServiceException$;
    exports2.Contact$ = Contact$;
    exports2.ContactContent$ = ContactContent$;
    exports2.ContactFilter$ = ContactFilter$;
    exports2.CreateCase$ = CreateCase$;
    exports2.CreateCaseCommand = CreateCaseCommand;
    exports2.CreateCaseRequest$ = CreateCaseRequest$;
    exports2.CreateCaseResponse$ = CreateCaseResponse$;
    exports2.CreateCaseRule$ = CreateCaseRule$;
    exports2.CreateCaseRuleCommand = CreateCaseRuleCommand;
    exports2.CreateCaseRuleRequest$ = CreateCaseRuleRequest$;
    exports2.CreateCaseRuleResponse$ = CreateCaseRuleResponse$;
    exports2.CreateDomain$ = CreateDomain$;
    exports2.CreateDomainCommand = CreateDomainCommand2;
    exports2.CreateDomainRequest$ = CreateDomainRequest$;
    exports2.CreateDomainResponse$ = CreateDomainResponse$;
    exports2.CreateField$ = CreateField$;
    exports2.CreateFieldCommand = CreateFieldCommand;
    exports2.CreateFieldRequest$ = CreateFieldRequest$;
    exports2.CreateFieldResponse$ = CreateFieldResponse$;
    exports2.CreateLayout$ = CreateLayout$;
    exports2.CreateLayoutCommand = CreateLayoutCommand;
    exports2.CreateLayoutRequest$ = CreateLayoutRequest$;
    exports2.CreateLayoutResponse$ = CreateLayoutResponse$;
    exports2.CreateRelatedItem$ = CreateRelatedItem$;
    exports2.CreateRelatedItemCommand = CreateRelatedItemCommand;
    exports2.CreateRelatedItemRequest$ = CreateRelatedItemRequest$;
    exports2.CreateRelatedItemResponse$ = CreateRelatedItemResponse$;
    ...
    exports2.CustomContent$ = CustomContent$;
    exports2.CustomFieldsFilter$ = CustomFieldsFilter$;
    exports2.CustomFilter$ = CustomFilter$;
    exports2.CustomInputContent$ = CustomInputContent$;
    exports2.DeleteCase$ = DeleteCase$;
    exports2.DeleteCaseCommand = DeleteCaseCommand;
    exports2.DeleteCaseRequest$ = DeleteCaseRequest$;
    exports2.DeleteCaseResponse$ = DeleteCaseResponse$;
    exports2.DeleteCaseRule$ = DeleteCaseRule$;
    exports2.DeleteCaseRuleCommand = DeleteCaseRuleCommand;
    exports2.DeleteCaseRuleRequest$ = DeleteCaseRuleRequest$;
    exports2.DeleteCaseRuleResponse$ = DeleteCaseRuleResponse$;
    exports2.DeleteDomain$ = DeleteDomain$;
    exports2.DeleteDomainCommand = DeleteDomainCommand2;
    exports2.DeleteDomainRequest$ = DeleteDomainRequest$;
    exports2.DeleteDomainResponse$ = DeleteDomainResponse$;
    exports2.DeleteField$ = DeleteField$;
    exports2.DeleteFieldCommand = DeleteFieldCommand;
    exports2.DeleteFieldRequest$ = DeleteFieldRequest$;
    exports2.DeleteFieldResponse$ = DeleteFieldResponse$;
    exports2.DeleteLayout$ = DeleteLayout$;
    exports2.DeleteLayoutCommand = DeleteLayoutCommand;
    exports2.DeleteLayoutRequest$ = DeleteLayoutRequest$;
    exports2.DeleteLayoutResponse$ = DeleteLayoutResponse$;
    exports2.DeleteRelatedItem$ = DeleteRelatedItem$;
    exports2.DeleteRelatedItemCommand = DeleteRelatedItemCommand;
    exports2.DeleteRelatedItemRequest$ = DeleteRelatedItemRequest$;
    exports2.DeleteRelatedItemResponse$ = DeleteRelatedItemResponse$;
    ...
    exports2.DomainStatus = DomainStatus;
    exports2.DomainSummary$ = DomainSummary$;
    exports2.EmptyFieldValue$ = EmptyFieldValue$;
    exports2.EmptyOperandValue$ = EmptyOperandValue$;
    exports2.EventBridgeConfiguration$ = EventBridgeConfiguration$;
    exports2.EventIncludedData$ = EventIncludedData$;
    exports2.FieldError$ = FieldError$;
    exports2.FieldFilter$ = FieldFilter$;
    exports2.FieldGroup$ = FieldGroup$;
    exports2.FieldIdentifier$ = FieldIdentifier$;
    exports2.FieldItem$ = FieldItem$;
    exports2.FieldNamespace = FieldNamespace;
    exports2.FieldOption$ = FieldOption$;
    exports2.FieldOptionError$ = FieldOptionError$;
    exports2.FieldOptionsCaseRule$ = FieldOptionsCaseRule$;
    exports2.FieldSummary$ = FieldSummary$;
    exports2.FieldType = FieldType;
    exports2.FieldValue$ = FieldValue$;
    exports2.FieldValueUnion$ = FieldValueUnion$;
    exports2.FileContent$ = FileContent$;
    exports2.FileFilter$ = FileFilter$;
    exports2.GetCase$ = GetCase$;
    exports2.GetCaseAuditEvents$ = GetCaseAuditEvents$;
    exports2.GetCaseAuditEventsCommand = GetCaseAuditEventsCommand;
    exports2.GetCaseAuditEventsRequest$ = GetCaseAuditEventsRequest$;
    exports2.GetCaseAuditEventsResponse$ = GetCaseAuditEventsResponse$;
    exports2.GetCaseCommand = GetCaseCommand;
    exports2.GetCaseEventConfiguration$ = GetCaseEventConfiguration$;
    exports2.GetCaseEventConfigurationCommand = GetCaseEventConfigurationCommand;
    exports2.GetCaseEventConfigurationRequest$ = GetCaseEventConfigurationRequest$;
    exports2.GetCaseEventConfigurationResponse$ = GetCaseEventConfigurationResponse$;
    exports2.GetCaseRequest$ = GetCaseRequest$;
    exports2.GetCaseResponse$ = GetCaseResponse$;
    exports2.GetCaseRuleResponse$ = GetCaseRuleResponse$;
    exports2.GetDomain$ = GetDomain$;
    exports2.GetDomainCommand = GetDomainCommand;
    exports2.GetDomainRequest$ = GetDomainRequest$;
    exports2.GetDomainResponse$ = GetDomainResponse$;
    exports2.GetFieldResponse$ = GetFieldResponse$;
    exports2.GetLayout$ = GetLayout$;
    exports2.GetLayoutCommand = GetLayoutCommand;
    exports2.GetLayoutRequest$ = GetLayoutRequest$;
    exports2.GetLayoutResponse$ = GetLayoutResponse$;
    ...
    exports2.HiddenCaseRule$ = HiddenCaseRule$;
    exports2.InternalServerException = InternalServerException3;
    exports2.InternalServerException$ = InternalServerException$3;
    exports2.LayoutConfiguration$ = LayoutConfiguration$;
    exports2.LayoutContent$ = LayoutContent$;
    exports2.LayoutSections$ = LayoutSections$;
    exports2.LayoutSummary$ = LayoutSummary$;
    exports2.ListCaseRules$ = ListCaseRules$;
    exports2.ListCaseRulesCommand = ListCaseRulesCommand;
    exports2.ListCaseRulesRequest$ = ListCaseRulesRequest$;
    exports2.ListCaseRulesResponse$ = ListCaseRulesResponse$;
    exports2.ListCasesForContact$ = ListCasesForContact$;
    exports2.ListCasesForContactCommand = ListCasesForContactCommand;
    exports2.ListCasesForContactRequest$ = ListCasesForContactRequest$;
    exports2.ListCasesForContactResponse$ = ListCasesForContactResponse$;
    exports2.ListDomains$ = ListDomains$;
    exports2.ListDomainsCommand = ListDomainsCommand;
    exports2.ListDomainsRequest$ = ListDomainsRequest$;
    exports2.ListDomainsResponse$ = ListDomainsResponse$;
    exports2.ListFieldOptions$ = ListFieldOptions$;
    exports2.ListFieldOptionsCommand = ListFieldOptionsCommand;
    exports2.ListFieldOptionsRequest$ = ListFieldOptionsRequest$;
    exports2.ListFieldOptionsResponse$ = ListFieldOptionsResponse$;
    exports2.ListFields$ = ListFields$;
    exports2.ListFieldsCommand = ListFieldsCommand;
    exports2.ListFieldsRequest$ = ListFieldsRequest$;
    exports2.ListFieldsResponse$ = ListFieldsResponse$;
    exports2.ListLayouts$ = ListLayouts$;
    exports2.ListLayoutsCommand = ListLayoutsCommand;
    exports2.ListLayoutsRequest$ = ListLayoutsRequest$;
    exports2.ListLayoutsResponse$ = ListLayoutsResponse$;
    exports2.ListTagsForResource$ = ListTagsForResource$;
    exports2.ListTagsForResourceCommand = ListTagsForResourceCommand;
    exports2.ListTagsForResourceRequest$ = ListTagsForResourceRequest$;
    exports2.ListTagsForResourceResponse$ = ListTagsForResourceResponse$;
    ...
    exports2.OperandOne$ = OperandOne$;
    exports2.OperandTwo$ = OperandTwo$;
    exports2.Order = Order;
    exports2.ParentChildFieldOptionsMapping$ = ParentChildFieldOptionsMapping$;
    exports2.PutCaseEventConfiguration$ = PutCaseEventConfiguration$;
    exports2.PutCaseEventConfigurationCommand = PutCaseEventConfigurationCommand;
    exports2.PutCaseEventConfigurationRequest$ = PutCaseEventConfigurationRequest$;
    exports2.PutCaseEventConfigurationResponse$ = PutCaseEventConfigurationResponse$;
    exports2.RelatedItemContent$ = RelatedItemContent$;
    exports2.RelatedItemEventIncludedData$ = RelatedItemEventIncludedData$;
    exports2.RelatedItemInputContent$ = RelatedItemInputContent$;
    exports2.RelatedItemType = RelatedItemType;
    exports2.RelatedItemTypeFilter$ = RelatedItemTypeFilter$;
    exports2.RequiredCaseRule$ = RequiredCaseRule$;
    exports2.RequiredField$ = RequiredField$;
    exports2.ResourceNotFoundException = ResourceNotFoundException;
    exports2.ResourceNotFoundException$ = ResourceNotFoundException$;
    exports2.RuleType = RuleType;
    exports2.SearchAllRelatedItems$ = SearchAllRelatedItems$;
    exports2.SearchAllRelatedItemsCommand = SearchAllRelatedItemsCommand;
    exports2.SearchAllRelatedItemsRequest$ = SearchAllRelatedItemsRequest$;
    exports2.SearchAllRelatedItemsResponse$ = SearchAllRelatedItemsResponse$;
    exports2.SearchAllRelatedItemsResponseItem$ = SearchAllRelatedItemsResponseItem$;
    exports2.SearchAllRelatedItemsSort$ = SearchAllRelatedItemsSort$;
    exports2.SearchAllRelatedItemsSortProperty = SearchAllRelatedItemsSortProperty;
    exports2.SearchCases$ = SearchCases$;
    exports2.SearchCasesCommand = SearchCasesCommand;
    exports2.SearchCasesRequest$ = SearchCasesRequest$;
    exports2.SearchCasesResponse$ = SearchCasesResponse$;
    exports2.SearchCasesResponseItem$ = SearchCasesResponseItem$;
    exports2.SearchRelatedItems$ = SearchRelatedItems$;
    exports2.SearchRelatedItemsCommand = SearchRelatedItemsCommand;
    exports2.SearchRelatedItemsRequest$ = SearchRelatedItemsRequest$;
    exports2.SearchRelatedItemsResponse$ = SearchRelatedItemsResponse$;
    exports2.SearchRelatedItemsResponseItem$ = SearchRelatedItemsResponseItem$;
    exports2.Section$ = Section$;
    exports2.ServiceQuotaExceededException = ServiceQuotaExceededException;
    exports2.ServiceQuotaExceededException$ = ServiceQuotaExceededException$;
    exports2.SlaConfiguration$ = SlaConfiguration$;
    exports2.SlaContent$ = SlaContent$;
    exports2.SlaFilter$ = SlaFilter$;
    exports2.SlaInputConfiguration$ = SlaInputConfiguration$;
    exports2.SlaInputContent$ = SlaInputContent$;
    exports2.SlaStatus = SlaStatus;
    exports2.SlaType = SlaType;
    exports2.Sort$ = Sort$;
    ...
    exports2.TemplateRule$ = TemplateRule$;
    exports2.TemplateStatus = TemplateStatus;
    exports2.TemplateSummary$ = TemplateSummary$;
    ...
    exports2.UpdateCase$ = UpdateCase$;
    exports2.UpdateCaseCommand = UpdateCaseCommand;
    exports2.UpdateCaseRequest$ = UpdateCaseRequest$;
    exports2.UpdateCaseResponse$ = UpdateCaseResponse$;
    exports2.UpdateCaseRule$ = UpdateCaseRule$;
    exports2.UpdateCaseRuleCommand = UpdateCaseRuleCommand;
    exports2.UpdateCaseRuleRequest$ = UpdateCaseRuleRequest$;
    exports2.UpdateCaseRuleResponse$ = UpdateCaseRuleResponse$;
    exports2.UpdateField$ = UpdateField$;
    exports2.UpdateFieldCommand = UpdateFieldCommand;
    exports2.UpdateFieldRequest$ = UpdateFieldRequest$;
    exports2.UpdateFieldResponse$ = UpdateFieldResponse$;
    exports2.UpdateLayout$ = UpdateLayout$;
    exports2.UpdateLayoutCommand = UpdateLayoutCommand;
    exports2.UpdateLayoutRequest$ = UpdateLayoutRequest$;
    exports2.UpdateLayoutResponse$ = UpdateLayoutResponse$;
    ...
    exports2.UserUnion$ = UserUnion$;
    exports2.ValidationException = ValidationException2;
    exports2.ValidationException$ = ValidationException$2;
    exports2.paginateGetCase = paginateGetCase;
    exports2.paginateGetCaseAuditEvents = paginateGetCaseAuditEvents;
    exports2.paginateListCaseRules = paginateListCaseRules;
    exports2.paginateListCasesForContact = paginateListCasesForContact;
    exports2.paginateListDomains = paginateListDomains;
    exports2.paginateListFieldOptions = paginateListFieldOptions;
    exports2.paginateListFields = paginateListFields;
    exports2.paginateListLayouts = paginateListLayouts;
    exports2.paginateListTemplates = paginateListTemplates;
    exports2.paginateSearchAllRelatedItems = paginateSearchAllRelatedItems;
    exports2.paginateSearchCases = paginateSearchCases;
    exports2.paginateSearchRelatedItems = paginateSearchRelatedItems;
  }
});

// src/connect-cases/domain.onEvent.ts
var domain_onEvent_exports = {};
__export(domain_onEvent_exports, {
  onEvent: () => onEvent
});
...
async function createDomain(event) {
  const props = event.ResourceProperties.Parameters;
  const response = await casesClient.send(
    new import_client_connectcases.CreateDomainCommand({
      name: props.name
    })
  );
...
async function getDomainInfo(event) {
